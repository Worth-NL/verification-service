...
export async function GET() {
  const spec = {
    ...
    info: {
      ...
      description:
        "API to create and verify email or phone number verification requests",
      version: "1.0.1",
    },
    servers: [
      {
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    phoneNumber: {
                      type: "string",
                      description:
                        "Phone number to verify (in E.164 format, e.g. +31612345678)",
                    },
                    reference: {
                      type: "string",
                    ...
                    templateId: {
                      type: "string",
                      description:
                        "Optional NotifyNL template ID (overrides environment variable for email or SMS)",
                    },
                  },
                  oneOf: [
                    { required: ["email"] },
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    email: {
                      ...
                      format: "email",
                      description:
                        "Email address (optional fallback if reference not found)",
                    },
                    phoneNumber: {
                      type: "string",
                      description:
                        "Phone number (optional fallback if reference and email not found)",
                    },
                  },
                  required: ["code"],
                  oneOf: [
                  ...
                  description:
                    "You must provide `code` and one of: `reference`, `email`, or `phoneNumber`.",
                },
              },
            },
          },
        ...
        VerifiedResponse: {
          ...
          properties: {
            ...
            verifiedOn: {
              ...
              format: "date-time",
              description:
                "Timestamp of successful verification in NEN-ISO 8601 format",
              example: "2026-01-05T14:32:41+01:00",
            },
          },
          required: ["verified", "verifiedOn"],
        },
        ErrorResponse: {
          type: "object",
          properties: {
